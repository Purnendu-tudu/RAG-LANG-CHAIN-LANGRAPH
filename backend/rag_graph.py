...
def create_rag_graph(retriever, llm=None, provider: str = None, temperature: float = 0.2, query_mode: str = "qa"):
    ...
    prompt_template = ChatPromptTemplate.from_messages([
        ("system", (
            ...
            "4. Senior Systems Engineering Diagrams: You are a senior systems engineer specializing in creating professional engineering diagrams resembling engineering documentation.\n"
            ...
            "        classDef sensors fill:#14532d,stroke:#22c55e,color:#f8fafc;\n"
