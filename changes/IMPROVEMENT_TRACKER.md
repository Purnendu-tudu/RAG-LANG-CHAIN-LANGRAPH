...
This folder (`changes/`) tracks step-by-step enhancements, bug fixes, and dataset prompt libraries applied to the RAG vector retrieval, query understanding, and response generation pipeline.

---

## Applied Improvements & Libraries Summary

| Fix / Resource ID | Description | Primary File Modified | Status | Date |
|---|---|---|---|---|
...
| [`06_interactive_kpi_charts`](file:///c:/Users/purne/Downloads/GitHub/RAG-LANG-CHAIN-LANGRAPH/changes/06_interactive_kpi_charts.md) | Approach 2: Interactive KPI Metric Cards & Recharts (Bar/Line/Pie) | `frontend/src/`, `backend/rag_graph.py` | ✅ Applied & Verified | 2026-08-05 |
| [`PROMPT_LIBRARY_CUSTOMER_SUPPORT`](file:///c:/Users/purne/Downloads/GitHub/RAG-LANG-CHAIN-LANGRAPH/changes/PROMPT_LIBRARY_CUSTOMER_SUPPORT.md) | **Customer Support Tickets Dataset Prompt Library** | `changes/PROMPT_LIBRARY_CUSTOMER_SUPPORT.md` | ✅ Created & Stored | 2026-08-05 |
